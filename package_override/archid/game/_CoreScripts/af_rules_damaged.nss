...
/**
*
* This script contains the EVENT_TYPE_DAMAGED event handling code from rules_core
*
* It is meant to be called from within creature_core if a custom override event handler is used
*
*/
void main()
{
