#ifndef AT_CONDITION_ALL_ENEMIES_USING_ATTACK_TYPE_H
#defsym AT_CONDITION_ALL_ENEMIES_USING_ATTACK_TYPE_H
...
//                                DECLARATIONS
//==============================================================================
object _AT_AI_Condition_AllEnemiesUsingAttackType(int nTacticCommand, int nTacticSubCommand, int nTargetType, int nTacticID, int nAbilityTargetType, int nAttackType);
