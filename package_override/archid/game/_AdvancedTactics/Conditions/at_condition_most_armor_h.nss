#ifndef AT_CONDITION_MOST_ENEMIES_HAVE_ARMOR_TYPE_H
#defsym AT_CONDITION_MOST_ENEMIES_HAVE_ARMOR_TYPE_H
...
//                                DECLARATIONS
//==============================================================================
object _AT_AI_Condition_MostEnemiesHaveArmorType(int nTacticCommand, int nTacticSubCommand, int nTargetType, int nTacticID, int nAbilityTargetType, int nArmorType);
...
object _AT_AI_Condition_MostEnemiesHaveArmorType(int nTacticCommand, int nTacticSubCommand, int nTargetType, int nTacticID, int nAbilityTargetType, int nArmorType)
{
    ...
    if (nEnemiesWithArmorType > (nSize - nEnemiesWithArmorType))
    {
        switch(nTargetType)
        {
