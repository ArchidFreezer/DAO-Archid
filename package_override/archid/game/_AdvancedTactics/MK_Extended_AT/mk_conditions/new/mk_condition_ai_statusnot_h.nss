#ifndef MK_CONDITION_GET_CREATURE_WITH_AI_STATUS_NOT_H
#defsym MK_CONDITION_GET_CREATURE_WITH_AI_STATUS_NOT_H
...
//                          DECLARATIONS
//==============================================================================
object _MK_AI_Condition_GetCreatureWithAIStatusNot(int nTacticCommand, int nTacticSubCommand, int nTargetType, int nTacticID, int nAbilityTargetType, int nAIStatus);
    ...
    {    
        ...
        case AI_TARGET_TYPE_MOST_HATED:
        {
            ...
            for (i = 0; i < nSize; i++)
            {
                ...
                &&  _MK_AI_HasAIStatus(arTargets[i], nAIStatus) == FALSE)
                    return arTargets[i];
            }
        ...
        default:
        {
            string sMsg = "[_MK_AI_Condition_GetCreatureWithAIStatusNot] ERROR: Unknown Target Type = " + IntToString(nTargetType);
