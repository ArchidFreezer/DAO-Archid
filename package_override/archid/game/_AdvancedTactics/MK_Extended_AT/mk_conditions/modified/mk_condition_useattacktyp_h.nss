#ifndef MK_CONDITION_USING_ATTACK_TYPE_H
#defsym MK_CONDITION_USING_ATTACK_TYPE_H
...
//                                DECLARATIONS
//==============================================================================
object _MK_AI_Condition_UsingAttackType(int nTacticCommand, int nTacticSubCommand, int nTargetType, int nTacticID, int nAbilityTargetType, int nAttackType, int nFlankn);

//==============================================================================
//                                DEFINITIONS
//==============================================================================
object _MK_AI_Condition_UsingAttackType(int nTacticCommand, int nTacticSubCommand, int nTargetType, int nTacticID, int nAbilityTargetType, int nAttackType, int nFlank)
{
    object[] arTargets;
    int nSize;
    int i;
    ...
    switch (nTargetType)
    {
        ...
        case AI_TARGET_TYPE_MOST_HATED:
        {
            ...
            for (i = 0; i < nSize; i++)
            {
                ...
                &&  ((nFlank == 0) || AT_IsAtFlank(GetAttackTarget(arTargets[i]))) == TRUE)
                    return arTargets[i];
            }
        ...
        default:
        {
            string sMsg = "[_MK_AI_Condition_UsingAttackType] ERROR: Unknown Target Type = " + IntToString(nTargetType);
