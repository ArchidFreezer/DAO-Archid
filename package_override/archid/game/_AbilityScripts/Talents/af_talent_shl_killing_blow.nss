...
void _HandleImpact(struct EventSpellScriptImpactStruct stEvent)
{
    ...
    eEffect = EffectModifyProperty(PROPERTY_ATTRIBUTE_ATTACK, -10.0, PROPERTY_ATTRIBUTE_REGENERATION_STAMINA_COMBAT, REGENERATION_STAMINA_COMBAT_DEGENERATION, PROPERTY_ATTRIBUTE_REGENERATION_STAMINA, REGENERATION_STAMINA_COMBAT_DEGENERATION);
