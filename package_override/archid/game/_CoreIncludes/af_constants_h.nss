...
const string AF_DAOAREA3_FLAG = "AF_DAOAREA3_FLAG";
...
const int AF_DAOAREA2_URN130AR    = 0x04000000;
const int AF_DAOAREA2_LTL100AR    = 0x08000000;
const int AF_DAOAREA2_LTL200AR    = 0x10000000;
const int AF_DAOAREA2_LTL300AR    = 0x20000000;
const int AF_DAOAREA2_LTL400AR    = 0x40000000;
const int AF_DAOAREA2_VGK330AR    = 0x80000000;

const int AF_DAOAREA3_TRP200AR    = 0x00000001;
const int AF_DAOAREA3_STR300AR    = 0x00000002;
const int AF_DAOAREA3_STR400AR    = 0x00000004;
const int AF_DAOAREA3_BHM250AR    = 0x00000008;
const int AF_DAOAREA3_BED110AR    = 0x00000010;
const int AF_DAOAREA3_BDC120AR    = 0x00000020;
const int AF_DAOAREA3_BDN200AR    = 0x00000040;
const int AF_DAOAREA3_BDN400AR    = 0x00000080;
const int AF_DAOAREA3_URN210AR    = 0x00000100;
const int AF_DAOAREA3_RAN210AR    = 0x00000200;
const int AF_DAOAREA3_RAN250AR    = 0x00000400;
const int AF_DAOAREA3_RAN270AR    = 0x00000800;
const int AF_DAOAREA3_RAN290AR    = 0x00001000;
const int AF_DAOAREA3_RAN310AR    = 0x00002000;
const int AF_DAOAREA3_RAN520AR    = 0x00004000;
const int AF_DAOAREA3_RAN530AR    = 0x00008000;
const int AF_DAOAREA3_ORZ520AR    = 0x00010000;
const int AF_DAOAREA3_ORZ540AR    = 0x00020000;
const int AF_DAOAREA3_KKC300AR    = 0x00040000;
...
const int AF_GENERAL_LELIANA_BATHE   = 0x00000008;
