...
const int AF_DAOAREA1_ARL01AL     = 0x00000001;
const int AF_DAOAREA1_ARL02AL     = 0x00000002;
...
const int AF_DAOAREA1_DEN02AL     = 0x00000200;
const int AF_DAOAREA1_DEN03AL     = 0x00000400;
...
const int AF_DAOAREA1_KCC01AL     = 0x00080000;
const int AF_DAOAREA1_LOT100AR    = 0x00100000;
const int AF_DAOAREA1_LOT110AR    = 0x00200000;
const int AF_DAOAREA1_NTB01AL     = 0x00400000;
const int AF_DAOAREA1_NTB02AL     = 0x00800000;
...
const int AF_DAOAREA1_ORZ06AL     = 0x80000000;

const int AF_DAOAREA2_ORZ07AL     = 0x00000001;
const int AF_DAOAREA2_ORZ08AL     = 0x00000002;
const int AF_DAOAREA2_ORZ230AR    = 0x00000004;
const int AF_DAOAREA2_ORZ320AR    = 0x00000008;
const int AF_DAOAREA2_PRE01AL     = 0x00000010;
const int AF_DAOAREA2_PRE02AL     = 0x00000020;
const int AF_DAOAREA2_PRE04AL     = 0x00000040;
...
const int AF_DAOAREA2_SHL300AL    = 0x00000400;
