...
const resource AF_ABILITY_BLIZZARD_OVERRIDE_SCRIPT = R"af_spell_blizzard.ncs";
const resource AF_ABILITY_GREASE_OVERRIDE_SCRIPT   = R"af_spell_grease.ncs";
...
void main() {
    ...
    if (!HasAbility(oCaster, AF_ABILITY_SPELLSHAPING) || !Ability_IsAbilityActive(oCaster, AF_ABILITY_SPELLSHAPING)) {
    ...
    switch (nAbility) {
        case ABILITY_SPELL_FIREBALL:
            AF_LogDebug("FIREBALL!", AF_LOGGROUP_SPELLSHAPING);
            break;
        case ABILITY_SPELL_CONE_OF_COLD:
            AF_LogDebug("CONE OF COLD!", AF_LOGGROUP_SPELLSHAPING);
            break;
        case ABILITY_SPELL_GREASE:
            AF_LogDebug("GREASE!", AF_LOGGROUP_SPELLSHAPING);
            nSpellCast = AF_SS_SPELL_GREASE;
            break;
        case ABILITY_SPELL_BLIZZARD:
            AF_LogDebug("BLIZZARD!", AF_LOGGROUP_SPELLSHAPING);
    ...
    switch (nSpellCast) {
        case AF_SS_SPELL_GREASE: {
            AF_LogDebug("Handling GREASE", AF_LOGGROUP_SPELLSHAPING);
            ...
            AF_LogDebug("GREASE Applying Effect", AF_LOGGROUP_SPELLSHAPING);
            effect eAoE = EffectAreaOfEffect(GREASE_AOE, AF_ABILITY_GREASE_OVERRIDE_SCRIPT, GREASE_AOE_VFX);
        ...
        case AF_SS_SPELL_BLIZZARD: {
            AF_LogDebug("Handling BLIZZARD", AF_LOGGROUP_SPELLSHAPING);
            ...
            {
                effect eAoE = EffectAreaOfEffect(BLIZZARD_AOE, AF_ABILITY_BLIZZARD_OVERRIDE_SCRIPT, BLIZZARD_AOE_VFX);
