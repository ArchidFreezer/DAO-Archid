...
void main() {
    ...
    switch(nEventType) {
        case EVENT_TYPE_SPELLSCRIPT_PENDING: {
            ...
            AF_LogDebug("EVENT_TYPE_SPELLSCRIPT_PENDING: " + Log_GetAbilityNameById(stEvent.nAbility), AF_LOGGROUP_EDS);
        ...
        case EVENT_TYPE_SPELLSCRIPT_CAST: {
            ...
            AF_LogDebug("EVENT_TYPE_SPELLSCRIPT_CAST: " + Log_GetAbilityNameById(stEvent.nAbility), AF_LOGGROUP_EDS);
            //------------------------------------------------------------------
        ...
        case EVENT_TYPE_SPELLSCRIPT_IMPACT: {
            ...
            AF_LogDebug("EVENT_TYPE_SPELLSCRIPT_IMPACT: " + Log_GetAbilityNameById(stEvent.nAbility), AF_LOGGROUP_EDS);
